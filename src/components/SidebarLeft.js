...
const notActiveStyle = 'flex items-center gap-3 text-[#fff] text-[13px] w-full h-10 py-2 px-[25px] font-bold';
const activeStyle =
    ...
    return (
        <div className="flex flex-col bg-[#221a2d]">
            <div className="w-full h-[70px] py-[15px] px-[25px] flex items-center justify-start">
                <img src={logo} alt="logo" className="w-[120px] h-10 object-contain" />
            </div>
